...
public class CPhoneActivity extends BaseEditActivity {
	...
	protected void onInitAttribute(BaseAttribute ba) {
		...
		ba.mTitleTextStringId = R.string.setup_cellphone;
	}

	public static void launch(Activity activity,String def){
		Intent intent = new Intent(activity, CPhoneActivity.class);
