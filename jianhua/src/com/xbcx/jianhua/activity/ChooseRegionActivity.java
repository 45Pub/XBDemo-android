...
public class ChooseRegionActivity extends XBaseActivity implements
	...
	private void initListView(){
		...
		View viewHeader = layoutInflater.inflate(R.layout.section_divider, null);
		viewHeader.setMinimumHeight(SystemUtils.dipToPixel(this,10));
		mListView.addHeaderView(viewHeader);
		
		View viewFooter = layoutInflater.inflate(R.layout.section_divider, null);
	...
	private static class ChooseRegionAdapter extends BaseExpandableListAdapter{
		...
		public View getGroupView(int groupPosition, 
			...
			View v = convertView;
			if(v == null){
				v = LayoutInflater.from(mContext).inflate(R.layout.textview_region, null);
			}
